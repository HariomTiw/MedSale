    ...
    <div className="flex flex-col min-h-[100vh] dark:bg-gray-600">
      ...
      {/* <header className="px-4 lg:px-6 h-14 flex items-center justify-center dark:bg-gray-800">
        <a
          ...
          <span className="sr-only">MedSale</span>
        </a>
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-gray-500 md:text-xl dark:text-gray-400">
                    Providing innovative pharmaceutical products and services to
                    improve lives.
                  </p>
                </div>
          ...
          <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
            <div className="space-y-3">
              ...
              <p className="mx-auto max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                Join us in our mission to deliver cutting-edge healthcare
            ...
            <div className="mx-auto w-full max-w-sm space-y-2">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">
                Sign up to receive updates and news from MedSale.
          ...
          <div className="container grid items-center gap-6 px-4 md:px-6 lg:grid-cols-2 lg:gap-10">
            <div className="space-y-2">
              ...
              <p className="max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                Discover how MedSale is revolutionizing healthcare with our
          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-10 sm:px-10 md:gap-16 md:grid-cols-2">
              <div className="space-y-4">
                <div className="inline-block rounded-lg bg-gray-100 px-3 py-1 text-sm dark:text-gray-400 dark:bg-gray-700 text-gray-900">
                  Innovation
                </div>
                <h2 className="lg:leading-tighter text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl xl:text-[3.4rem] 2xl:text-[3.75rem] text-gray-900 dark:text-gray-50">
              ...
              <div className="flex flex-col items-start space-y-4">
                ...
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl/relaxed dark:text-gray-400">
                  Our commitment to quality ensures that every product and
                  service we offer meets the highest standards.
                </p>
                <Link
          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-10 sm:px-10 md:gap-16 md:grid-cols-2">
              ...
              <div className="flex flex-col items-start space-y-4">
                ...
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl/relaxed dark:text-gray-400">
                  Engaging with local communities to promote health and
                  well-being.
                </p>
                <Link
                  className="inline-flex h-9 items-center justify-center rounded-md border border-gray-200 bg-white px-4 py-2 text-sm font-medium shadow-sm transition-colors hover:bg-gray-100 hover:text-gray-900 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50 dark:text-white dark:border-gray-800 dark:bg-gray-950 dark:hover:bg-gray-800 dark:hover:text-gray-50 dark:focus-visible:ring-gray-300"
      ...
      {/* <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400">© 2024 MedSale. All rights reserved.</p>
