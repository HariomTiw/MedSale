          ...
          >
            <dl className="grid max-w-screen-xl grid-cols-2 gap-8 p-4 mx-auto text-gray-900 sm:grid-cols-3 xl:grid-cols-6 dark:text-white sm:p-8">
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <dd className="text-gray-500 dark:text-gray-400">
                  Medical Professionals Connected
                </dd>
              </div>
              <div className="flex flex-col items-center justify-center">
        ...
        return (
          ...
          >
            ...
            <p className="mb-5 text-gray-500 dark:text-gray-400">
              At MedSale, we are on a mission to revolutionize healthcare
              through cutting-edge solutions and unwavering commitment. Our
              dedication extends beyond pharmaceuticals to create a healthier,
              ...
              {faqData.map((item, index) => (
                <div key={index}>
                    ...
                    >
                      ...
                      <svg
                        ...
                        className={`w-3 h-3 transition-transform transform ${
                          accordionState.faq[index] ? "rotate-180" : ""
                        }`}
                        aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                  ...
                  <div
                    ...
                    className={`${
                      accordionState.faq[index] ? "block" : "hidden"
        ...
        <li className="w-full">
          <button
            ...
            className={`inline-block w-full p-4 rounded-ss-lg ${
              activeTab === "stats"
                ? "bg-teal-500 text-white focus:outline-none"
